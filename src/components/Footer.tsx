    ...
    return (
        ...
        >
            <div className="flex justify-center gap-6 mb-2 text-lg">
                <Link
                    href="github.com/manishdotsqlite"
                    aria-label="GitHub"
                ...
                <Link
                    href="https://www.linkedin.com/in/manish-pokharel/"
                    aria-label="LinkedIn"
                    className="hover:text-blue-500 transition-transform hover:scale-125 duration-200"
                >
                    <FaLinkedin/>
                ...
                <Link
                    href="instagram.com/manishdotasm"
                ...
                <Link
                    href="mailto:manish.pokharel@proton.me"
                    target="_blank"
                    aria-label="Email"
                    className="hover:text-blue-500 transition-transform hover:scale-125 duration-200"
                >
            ...
            {/* Copyright section */}
            <p className="text-xs sm:text-sm">© {new Date().getFullYear()} Manish Pokharel. All rights reserved.</p>
